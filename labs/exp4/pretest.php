...
$a = array(
1 => array(
   0 => "how many types of operators are used in SQL",
   1 => "5",
   2 => "4",
   3 => "3",
   4 => "2",
...
2 => array(
   0 => "Arithmatic operator in SQL are used to perform",
...
3 =>  array(
    0=> "In SQL Relational operator are used to find",
    1 => "relation between entity set(table)",
   2 => "relation between columns",
   3 => "relation between entity (rows)",
   4 => "None of the above",
   6 => 3
),
4 =>  array(
    0=> "At the time of retrieving data using a SELECT statement, we can use",
...
5 =>  array(
    0=> "NOT operator is use to find",
    1 => "rows that do satisfy a condition",
   2 => "columns that do not satisfy a condition",
   3 => "rows that do satisfy a condition",
   4 => "rows that do not satisfy a condition",
   6 => 4
),
);
