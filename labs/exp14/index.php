            ...
            <!-- Content Header (Page header) -->
                ...
                <h1 align="center">
                   ...
                   <section class="theory">
                    ...
                    <p >
                    <i >&#x27A3;</i> To give you the fundamental knowledge of the PL/SQL's various functions and there uses.<br>
                    <i>&#x27A3;</i>In this experiment we are going to have,a deep understanding of the usage of PL/SQL's various function with example</p>
                    <p >1.SELECT statement<br>
	                     2.CREATE statement<br>
	                     3.DELETE statement<br>
                       4.UPDATE statemet<br>
                       5.Programming constructs etc.<br>
                     </p>
                   </section>
